...
const SolutionDetail: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchSolution = async () => {
      setLoading(true);
      try {
        const item = await solutionsService.getSolution(slug);
        setSolution(item);
      } catch (err) {
        console.error(err);
      } finally {
    ...
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center space-y-6">
        ...
        <p className="text-sm text-muted">
          The requested solution is not cataloged in the repository.
        </p>
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {solution.benefits && solution.benefits.map((benefit, idx) => (
